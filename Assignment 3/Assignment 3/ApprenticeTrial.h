...
#pragma region Windows Form Variables
	...
	private: System::Windows::Forms::PictureBox^  poison_buff_potion;
...
private: System::Windows::Forms::PictureBox^  powerup_buff_potion;
...
#pragma region Windows Form Designer generated code
		...
		this->poison_buff_potion = (gcnew System::Windows::Forms::PictureBox());
		...
		this->powerup_buff_potion = (gcnew System::Windows::Forms::PictureBox());
		this->inventory = (gcnew System::Windows::Forms::Button());
		this->menu = (gcnew System::Windows::Forms::Button());
		(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->poison_buff_potion))->BeginInit();
		...
		(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->powerup_buff_potion))->BeginInit();
		this->SuspendLayout();
		// 
		// draw
		// 
		...
		// poison_buff_potion
		// 
		this->poison_buff_potion->AccessibleDescription = L"50";
		this->poison_buff_potion->AccessibleName = L"mana";
		this->poison_buff_potion->BackColor = System::Drawing::Color::Transparent;
		this->poison_buff_potion->BackgroundImageLayout = System::Windows::Forms::ImageLayout::None;
		this->poison_buff_potion->Image = (cli::safe_cast<System::Drawing::Image^  >(resources->GetObject(L"poison_buff_potion.Image")));
		this->poison_buff_potion->Location = System::Drawing::Point(202, 203);
		this->poison_buff_potion->Name = L"poison_buff_potion";
		this->poison_buff_potion->Size = System::Drawing::Size(40, 40);
		this->poison_buff_potion->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
		this->poison_buff_potion->TabIndex = 89;
		this->poison_buff_potion->TabStop = false;
		this->poison_buff_potion->Tag = L"11";
		this->ability_info->SetToolTip(this->poison_buff_potion, L"Mana Potion\r\n\r\n50 Restore Mana");
		this->poison_buff_potion->DoubleClick += gcnew System::EventHandler(this, &ApprenticeTrial::potion_DoubleClick);
		this->poison_buff_potion->Click += gcnew System::EventHandler(this, &ApprenticeTrial::potion_DoubleClick);
		// 
		// mana_potion
		// 
		...
		this->mana_potion->Location = System::Drawing::Point(114, 203);
		...
		this->health_potion->Location = System::Drawing::Point(25, 203);
		...
		this->electric_storm->Location = System::Drawing::Point(462, 282);
		...
		this->greater_ice->Location = System::Drawing::Point(377, 282);
		...
		this->lesser_ice->Location = System::Drawing::Point(290, 282);
		...
		this->whirlwind->Location = System::Drawing::Point(202, 282);
		...
		this->greater_wand->Location = System::Drawing::Point(114, 282);
		...
		this->lesser_wand->Location = System::Drawing::Point(25, 282);
		...
		this->brutal_staff_buff->Location = System::Drawing::Point(237, 117);
		...
		this->apprentice_staff_buff->Location = System::Drawing::Point(25, 117);
		...
		this->destroyer_buff->Location = System::Drawing::Point(237, 46);
		...
		this->staff_of_magi_buff->Location = System::Drawing::Point(343, 117);
		...
		this->apprentice_sword_buff->Location = System::Drawing::Point(25, 46);
		...
		this->ultimate_fury_buff->Location = System::Drawing::Point(449, 46);
		...
		this->pig_slaughter_buff->Location = System::Drawing::Point(131, 46);
		...
		this->cocoons_bane_buff->Location = System::Drawing::Point(343, 46);
		...
		this->peruna_death_buff->Location = System::Drawing::Point(131, 117);
		...
		this->new_game->Location = System::Drawing::Point(421, 475);
		...
		this->start_screen->Controls->Add(this->pictureBox1);
		...
		this->start_screen->Location = System::Drawing::Point(26, 26);
		...
		this->pictureBox1->Location = System::Drawing::Point(144, 343);
		...
		this->resume_game->Font = (gcnew System::Drawing::Font(L"Tahoma", 24, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
			static_cast<System::Byte>(0)));
		this->resume_game->Location = System::Drawing::Point(421, 428);
		...
		this->copyright->Location = System::Drawing::Point(12, 685);
		this->copyright->Name = L"copyright";
		this->copyright->Size = System::Drawing::Size(169, 40);
		this->copyright->TabIndex = 33;
		this->copyright->Text = L"Copyright © 2013";
		...
		this->exit->Font = (gcnew System::Drawing::Font(L"Tahoma", 24, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
			static_cast<System::Byte>(0)));
		this->exit->Location = System::Drawing::Point(421, 569);
		...
		this->help->Font = (gcnew System::Drawing::Font(L"Tahoma", 24, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
			static_cast<System::Byte>(0)));
		this->help->Location = System::Drawing::Point(421, 522);
		...
		this->inventory_panel->Controls->Add(this->poison_buff_potion);
		...
		this->inventory_panel->Controls->Add(this->powerup_buff_potion);
		...
		this->electric_storm_label->Location = System::Drawing::Point(471, 264);
		...
		this->greater_ice_label->Location = System::Drawing::Point(386, 264);
		...
		this->lesser_ice_label->Location = System::Drawing::Point(300, 264);
		...
		this->whirlwind_label->Location = System::Drawing::Point(208, 264);
		...
		this->greater_wand_label->Location = System::Drawing::Point(119, 264);
		...
		this->lesser_wand_label->Location = System::Drawing::Point(34, 264);
		...
		this->ultimate_fury->Location = System::Drawing::Point(459, 28);
		...
		this->cocoons_bane->Location = System::Drawing::Point(355, 28);
		...
		this->destroyer->Location = System::Drawing::Point(244, 28);
		...
		this->pig_slaughter->Location = System::Drawing::Point(141, 28);
		...
		this->apprentice_sword->Location = System::Drawing::Point(34, 28);
		...
		this->staff_of_magi->Location = System::Drawing::Point(355, 100);
		...
		this->brutal_staff->Location = System::Drawing::Point(246, 100);
		...
		this->peruna_death->Location = System::Drawing::Point(141, 99);
		...
		this->mana_potion_number->Location = System::Drawing::Point(160, 217);
		...
		this->health_potion_number->Location = System::Drawing::Point(71, 217);
		...
		this->melee_buff_number->Location = System::Drawing::Point(244, 217);
		...
		this->mana->Location = System::Drawing::Point(124, 185);
		...
		this->magic_buff_number->Location = System::Drawing::Point(336, 217);
		...
		this->apprentice_staff->Location = System::Drawing::Point(34, 99);
		...
		this->health->Location = System::Drawing::Point(34, 185);
		...
		this->poison_buff->Location = System::Drawing::Point(208, 185);
		...
		this->magic_buff->Location = System::Drawing::Point(300, 185);
		this->magic_buff->Name = L"magic_buff";
		this->magic_buff->Size = System::Drawing::Size(38, 15);
		this->magic_buff->TabIndex = 103;
		this->magic_buff->Text = L"Power";
		// 
		// magic_abilites
		// 
		...
		this->magic_abilites->Location = System::Drawing::Point(287, 246);
		...
		this->multiplier_label->Location = System::Drawing::Point(22, 13);
		...
		this->potion_label->Location = System::Drawing::Point(22, 170);
		...
		this->melee_abilites->Location = System::Drawing::Point(22, 246);
		...
		// powerup_buff_potion
		// 
		this->powerup_buff_potion->AccessibleDescription = L"50";
		this->powerup_buff_potion->AccessibleName = L"health";
		this->powerup_buff_potion->BackColor = System::Drawing::Color::Transparent;
		this->powerup_buff_potion->BackgroundImageLayout = System::Windows::Forms::ImageLayout::None;
		this->powerup_buff_potion->Image = (cli::safe_cast<System::Drawing::Image^  >(resources->GetObject(L"powerup_buff_potion.Image")));
		this->powerup_buff_potion->Location = System::Drawing::Point(290, 203);
		this->powerup_buff_potion->Name = L"powerup_buff_potion";
		this->powerup_buff_potion->Size = System::Drawing::Size(40, 40);
		this->powerup_buff_potion->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
		this->powerup_buff_potion->TabIndex = 87;
		this->powerup_buff_potion->TabStop = false;
		this->powerup_buff_potion->Tag = L"11";
		this->powerup_buff_potion->DoubleClick += gcnew System::EventHandler(this, &ApprenticeTrial::potion_DoubleClick);
		this->powerup_buff_potion->Click += gcnew System::EventHandler(this, &ApprenticeTrial::potion_DoubleClick);
		// 
		// inventory
		// 
		...
		(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->poison_buff_potion))->EndInit();
		...
		(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->powerup_buff_potion))->EndInit();
...
private: System::Void ApprenticeTrial_Load(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 items = gcnew ArrayList();
				 items->Add(gcnew Item(dbGraphics, apprentice_staff_buff));
				 items->Add(gcnew Item(dbGraphics, apprentice_sword_buff));
				 items->Add(gcnew Item(dbGraphics, pig_slaughter_buff));
				 items->Add(gcnew Item(dbGraphics, destroyer_buff));
				 items->Add(gcnew Item(dbGraphics, cocoons_bane_buff));
				 items->Add(gcnew Item(dbGraphics, ultimate_fury_buff));
				 items->Add(gcnew Item(dbGraphics, peruna_death_buff));
				 items->Add(gcnew Item(dbGraphics, brutal_staff_buff));
				 items->Add(gcnew Item(dbGraphics, staff_of_magi_buff));
				 items->Add(gcnew Item(dbGraphics, health_potion));
				 items->Add(gcnew Item(dbGraphics, mana_potion));
				 items->Add(gcnew Item(dbGraphics, poison_buff_potion));
				 items->Add(gcnew Item(dbGraphics, powerup_buff_potion));


				 
				 
				 //SoundPlayer^ menuMusic = gcnew SoundPlayer("PK_menu.wav");
				 //menuMusic = gcnew SoundPlayer("PK_swing2.wav");
...
private: System::Void draw_Tick(System::Object^  sender, System::EventArgs^  e) {
				 if(gameHasLoaded)
				 {
					 ...
					 Item^ pickupItem = safe_cast<Item^>(items[0]);
...
private: System::Void ApprenticeTrial::setToolTips() {
			 ...
			 ability_info->SetToolTip(magic_multiplier, "Melee\tx" + magic_multiplier->AccessibleName + "\nMagic\tx" + magic_multiplier->AccessibleDescription);
		  ...
		  // Accessible Name		: mana damage multiplier
