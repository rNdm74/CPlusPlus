...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->electric_storm->AccessibleName = L"20";
			...
			this->greater_ice->AccessibleName = L"15";
			...
			this->lesser_ice->AccessibleName = L"10";
			...
			// greater_wand
			// 
			this->greater_wand->AccessibleDescription = L"5";
			...
			// lesser_wand
			// 
			this->lesser_wand->AccessibleDescription = L"0";
			...
			// use_melee_ability
			// 
			this->use_melee_ability->AccessibleDescription = L"1";
...
private: System::Void Execute_Click_Hud_Item(PictureBox^ ability, System::Windows::Forms::MouseEventArgs^  e) {				 
				 switch ( e->Button )
				 {
					case ::MouseButtons::Left:
						...
						{
							gManager->setPlayerHealthCost(generateMeleeStats());
							gManager->setPlayerManaCost(generateMagicStats());
...
private: int ApprenticeTrial::generateMeleeStats() {
			 int meleeDamage = int::Parse(use_melee_ability->AccessibleName);
			 //int meleeManaCost = int::Parse(use_melee_ability->AccessibleDescription);
...
private: int ApprenticeTrial::generateMagicStats() {
			 ...
			 //int magicManaCost = int::Parse(use_magic_ability->AccessibleDescription);
