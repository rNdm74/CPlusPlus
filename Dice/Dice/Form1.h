...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->title = (gcnew System::Windows::Forms::Button());
			...
			this->playerOneRoll->Tag = L"PLAYER 1";
			...
			this->playerTwoRoll->Tag = L"PLAYER 2";
			...
			this->title->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->title->Location = System::Drawing::Point(12, 13);
			this->title->Name = L"title";
			this->title->Size = System::Drawing::Size(760, 44);
...
private: System::Void playerOneRoll_Click(System::Object^  sender, System::EventArgs^  e) {
			 if(roll(Player::ONE, playerOneDice, playerOneScore, runningTotalPlayer1Value)) 
				isGameOver(sender);
		 }

private: System::Void playerTwoRoll_Click(System::Object^  sender, System::EventArgs^  e) {
			 if(roll(Player::TWO, playerTwoDice, playerTwoScore, runningTotalPlayer2Value))
				isGameOver(sender);
		 }
private: Form1::Void isGameOver(System::Object^  sender) {
			 Button^ button = safe_cast<Button^>(sender);

			 System::Windows::Forms::DialogResult result = MessageBox::Show
			 (
				button->Tag + " WINS\n\nPLAY AGAIN", "GAMEOVER", System::Windows::Forms::MessageBoxButtons::YesNo
			 );

			 System::Windows::Forms::DialogResult::Yes == result ? Application::Restart() : Application::Exit();
		 }

private: bool Form1::roll(Player player, array<PictureBox^>^ pBoxs, Label^ pScore, Label^ rScoreValue) {
			 ...
			 return int::Parse(rScoreValue->Text) >= WIN_CONDITION;
		 }
