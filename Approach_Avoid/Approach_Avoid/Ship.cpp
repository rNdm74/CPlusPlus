...
Ship::Ship(EBoundsAction startAction, Graphics^ startCanvas, array<String^>^ filenames, int nFrames, Random^ startRgen, Point startPos, int startBehavior)
		: Sprite(startAction, startCanvas, filenames, nFrames, startRgen, startPos)
{	
...
void Ship::move(int viewportWorldX, int viewportWorldY)
{
		//=======================================================================
...
void Ship::canSpriteMove(int viewportWorldX, int viewportWorldY)
{	
